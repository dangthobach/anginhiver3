...
!function(window){
  ...
  window.GrooveWidget = {
    ...
    setup: function() {
      ...
      // Close widget when user clicks outside of it
      addEventListener(window, 'click', function(e) {
        // ignore '.js-groove-ignore' and SELECT elements
        if (!_this.opened || hasClass(e.target, 'js-groove-ignore') || e.target.tagName === 'SELECT') return;

        var isTargetInWidgetContainer = closest(e.target, function(el){ return el === _this.container });
        if (!isTargetInWidgetContainer) _this.close();
      });

      // Close widget when user presses ESC
    ...
    isIOSDevice: function() {
      return navigator.userAgent.match(/(iPhone);.*CPU.*OS [6,7,8,9]_\d/i);
    },
...
GrooveWidget.init({"position":"right","onlineHeaderText":"Have questions or feedback?","onlineHeaderTextOpen":"Search our FAQ or send us an email","offlineHeaderText":"Have questions or feedback?","offlineHeaderTextOpen":"Search our FAQ or send us an email","chattingWith":"Chatting with","url":"https://eatthismuch.groovehq.com/widgets/55be9b44-0d5f-42f8-8b33-d3c4b4702b36/ticket/init","stylesheet":"https://eatthismuch.groovehq.com/assets/groove.widget-47b1dcc560229973d86b56d20e187379.css","customization_stylesheet":"https://eatthismuch.groovehq.com/widgets/55be9b44-0d5f-42f8-8b33-d3c4b4702b36/ticket/customization.css","height":"70px","origin":"https://eatthismuch.groovehq.com","enduser_name":"","enduser_email":"","onlyShowOnline":false,"poweredByGrooveText":"Powered by Groove","chatOnly":false});
